...
$email = "AdminEmailAlias@microsoft.com"
$isGcsEnabled = $true
$adminSg = "REDMOND\MyAdminSG" # TODO: Should this be customers or operators SG
$adminUsers = "adminUserAliasOne","adminUserAliasOne" # Optional

# NAMESPACE CREATION
$namespace = "MyWarmPathNamespace"
$serviceTreeId = "00000000-0000-0000-0000-000000000000"

# USER ROLE CREATION (Can be set to $null to create user roles without adding security groups)
$readOnlySecurityGroup = "REDMOND\MyReadOnlySG"
$readWriteSecurityGroup = "REDMOND\MyReadWriteSG"

# REQUIRED FOR GCS ONLY
$maCertificateThumbprint = "THUMBPRINT"
$maCertificateIssuer = "ISSUER"

# OPTIONAL MONIKER CREATION ($moniker, $region, $storageAccountName, $storageAccountKey, $eventHubAccountName, $eventHubAccountConnectionString, $encryptSecrets)
$monikers = @(
...
# OPTIONAL CONFIG CREATION ($configNamespace, $majorVersion, $mainConfigFilePath, $importsDirectoryPath)
$configs = @(
...
# CREATE ACCOUNT
CreateWarmPathAccount -environment $environment -accountName $account -email $email  -isGcsEnabled $isGcsEnabled -adminSecurityGroup $adminSg -adminUserAliases $adminUsers

.\AddNamespace.ps1
.\AddOrUpdateMonikers.ps1
.\AddOrUpdateConfigurations.ps1
# SIG # Begin signature block
# MIInOQYJKoZIhvcNAQcCoIInKjCCJyYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCByrqTlS+TB4Foa
# 5JSL+McL/VwObMMLiO/h3m5w3wDn3qCCEWkwggh7MIIHY6ADAgECAhM2AAABOgNw
...
# AgEVMC8GCSqGSIb3DQEJBDEiBCD+hYESOcFZqWGWoOYvVTuRe1atJ6cOeurU/lrV
# v5UD2DBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBmAHShGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBADtO2Ylk
# 97P3aIJddlnlVZvH6UY7jfOrcPcp6S2Vnq/rAHVsz1rMj8OKI587qxINOlQb8GQj
# QMf9jQpKhiZCw6gOzZMs6rmlJFpMzKMM8FoicxYIR0xPjaIEdSuf9UBFetxFEpRY
# grwV3EwSy37hb912BxkRTkNdMWzdwSLBaSbtrhwg74EaLEpwH8XFcvLTPgxcp87B
# UStedJr8TEpXkrPNeSn8vAOj8av1mYuFFfKlLNVq003wrRfuXYiAQ1YF2suuTv+a
# iCI18VJe+JowQCvYMjE4zZ8KMm58BK628WQkHLS0ipHjrBaBpsf2SFgfNs7l48HX
# BHQMHDRkMTOzJeehghLuMIIS6gYKKwYBBAGCNwMDATGCEtowghLWBgkqhkiG9w0B
# BwKgghLHMIISwwIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBVQYLKoZIhvcNAQkQAQSg
# ggFEBIIBQDCCATwCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgSbDs
# cMAv+ATYUCONjpRfugN+gR6VKZa77TLEJi00AckCBmAQB/fdchgTMjAyMTAyMDEx
# NzUzNDguODYxWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCAkcV+ksFGuuJGazLUPB6YpHfVl
# sauTlsqE9FbEYR8PwzCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EILxFaouv
...
# aBqLhF7ZPIC9qGRIJy7CgRazOX3REyBVl3AwDQYJKoZIhvcNAQELBQAEggEAX7cS
# GmYgaEY//D/rQ5gVxaTylkLjGKVtMHoo4hYZQVt8mx6U7Fk0V10Aa7pZBzyiJ4vT
# HmYaNhhboSnVVL99Bi+ojwzosWMX2H3eOM/ZHhmMWJrH1qJw2viyqUqjJk6Up5Vw
# vcd0RlFw+9tbK7eKvTZpcqoKtG6S2NkRESXTj6cfe4ZzxY9Be+K6gaqn5ZJJBE7A
# 7WnQQZVXN2mi/+wOgCq03wLwp9LKKhwm21a0RuSrbEolkeev73o6Xv4vWcLcpu2g
# uKsuP3ygitmgy29iOt3NMGeojb6HwCXyPtZ8ikIlvElI50TmO/njGo4bGvFSmTL+
# a4eAUjvnQQX3/dM9dg==

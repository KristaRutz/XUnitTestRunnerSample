...
# CREATE NAMESPACE
CreateWarmPathNamespace -environment $environment -accountName $account -namespace $namespace -serviceTreeGuid $null
            
# CREATE USER ROLES
CreateWarmPathUserRole -environment $environment -accountName $account -userRoleId "$($namespace)_RO" -namespace $namespace -securityGroup $readOnlySecurityGroup -certThumbprint $null -certIssuer $null -isReadOnly $true 
CreateWarmPathUserRole -environment $environment -accountName $account -userRoleId "$($namespace)_RW" -namespace $namespace -securityGroup $readWriteSecurityGroup -certThumbprint $null -certIssuer $null -isReadOnly $false

if ($isGcsEnabled)
{
    CreateWarmPathUserRole -environment $environment -accountName $account -userRoleId "$($namespace)_MaCommunication" -namespace $namespace -certThumbprint $maCertificateThumbprint -certIssuer $maCertificateIssuer -isReadOnly $false -isMaCommunication $true
}
# SIG # Begin signature block
# MIInOQYJKoZIhvcNAQcCoIInKjCCJyYCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCxNOLZT9WPc4PL
# kV5/RByLXjL5ukw7zJ8XcoWQ7vJR2aCCEWkwggh7MIIHY6ADAgECAhM2AAABOgNw
...
# AgEVMC8GCSqGSIb3DQEJBDEiBCDp4sTeaDF+OfnLahs8NBi3VZcQ6FlOC2q2vfq6
# b7/07zBCBgorBgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBmAHShGoAY
# aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3DQEBAQUABIIBACULUWoY
# 995/lfUlcU1Ro6DYwVaPEO3z5iA90kVv81VFOZx7s3uHQj/UVElUfAKF7+B+6Iil
# I9OpRWjHPo0aPCMP+ZCMSd8sKBJYSgV3CM+ePdHAvCk+JA6Utb96F0SqFAelPSbm
# fJrYJgzCoNtRs7X2+1fL5zG6t+NY7HPOv/S2/ZEyuX5kKOh3mrNLpaXSp21ej8tW
# E0gW2u+a0iUom+xcyz+HGl8M5udT2ipqrCJq/Pl2QV91L97pbo+tWuCNVk75Dwzc
# gbTvwUcsQDpm8Q8TIsRRIEqwm5KPySOJdE/bU8vVA3jsR1Jv6RkXg/czNXgtDjJU
# gBzn/ooxiAFf+J6hghLuMIIS6gYKKwYBBAGCNwMDATGCEtowghLWBgkqhkiG9w0B
# BwKgghLHMIISwwIBAzEPMA0GCWCGSAFlAwQCAQUAMIIBVQYLKoZIhvcNAQkQAQSg
# ggFEBIIBQDCCATwCAQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQgTuz2
# Pui+li0azSiToPYdqRbWPOAz7gQLEX4d+knhUbMCBmAQB/fdOxgTMjAyMTAyMDEx
# NzUzMzguOTgzWjAEgAIB9KCB1KSB0TCBzjELMAkGA1UEBhMCVVMxEzARBgNVBAgT
...
# CyqGSIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCCtqobUMy4bK4f03lE9CIVFKbK5
# f9FDg+B5CyYK5dFxXDCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EILxFaouv
...
# aBqLhF7ZPIC9qGRIJy7CgRazOX3REyBVl3AwDQYJKoZIhvcNAQELBQAEggEAX7pp
# IArH3Fzzd6Iii/PAjZB42o78jzC0z4K+IrqdxecLrS8BnENz63DAaqnVX5VYVqxq
# a9wNh+18j7B2UNN/xoasgP0Sg/LGP9xRa4ARmknpzpg9WfR950kpyQuEpfZPEG8A
# aunF6hDtDPYGKj5GYkSdZpiRPanLQ2NW4hNaWkQqdl5wlwUUsEdukLZmVf/InPY4
# erckPpQP3FYddTjZb4MVeP216A0GLe3x/WCVR3KYj1cu1QHPED5djneS1+rGfOQb
# ar7BE2xnlCdXjhbSxR3wP5VUDTiPwCcMM/k+gNHSPT52g9x5QAwssWs3aUe0Nrr8
# a34h5GBpRFAnlbEBzg==
